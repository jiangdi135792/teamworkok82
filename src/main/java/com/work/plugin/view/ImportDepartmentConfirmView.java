...
import com.work.plugin.imports.DepartmentValidationController;
...
public class ImportDepartmentConfirmView extends JiraWebActionSupport
{
    private final DepartmentValidationController validationController;
    ...
    {
        return "ImportDepartmentResultView.jspa";
    }
}

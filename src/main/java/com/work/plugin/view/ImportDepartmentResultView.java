...
import com.work.plugin.imports.data.DepartmentDataProcess;
...
public class ImportDepartmentResultView extends JiraWebActionSupport
{
    private final DepartmentDataProcess dataProcess;
